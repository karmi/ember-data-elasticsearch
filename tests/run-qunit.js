...
// https://github.com/emberjs/data/blob/master/tests/qunit/run-qunit.js
...
function logQUnit() {
  ...
  console.log(divider);
  console.log("QUnit URL params: " + JSON.stringify(QUnit.urlParams));
  console.log(divider);
  ...
  QUnit.testDone(function(context) {
    ...
    console.log("Test", (context.failed ? "FAILED" : "succeeded"), ':', context.name)
    if (context.failed) {
